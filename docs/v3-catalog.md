...
**GET** /catalog/variants | Returns a paginated collection of Variants objects from the BigCommerce Catalog.
...
**GET** /catalog/products/{product_id}/images | Returns list of product images
**POST** /catalog/products/{product_id}/images | Creates an image on a product. Files (form post) are valid parameters.
**GET** /catalog/products/{product_id}/images/{image_id} | Returns specific product image
**PUT** /catalog/products/{product_id}/images/{image_id} | Updates specific product image
**DELETE** /catalog/products/{product_id}/images/{image_id} | Removes specific product image
...
**POST** /catalog/categories/{category_id}/image | Creates an image on a category. Publically accessible URLs and files (form post) are valid parameters.
**DELETE** /catalog/categories/{category_id}/image | Delete a Category image the BigCommerce Catalog
...
**POST** /catalog/brands/{brand_id}/image | Creates an image on a Brand. Publically accessible URLs and files (form post) are valid parameters.
